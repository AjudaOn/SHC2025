...
urlpatterns = [    
    ...
    path('relatorio_censo_mes/', views.Visualizar_Censo_Mes.as_view(), name='relatorio_censo_mes'), 
    path('relatorio_censo_ano/', views.Visualizar_Censo_Ano.as_view(), name='relatorio_censo_ano'), 
    path('relatorio_hospedagem/', views.RelatorioHospedagemView.as_view(), name='relatorio_hospedagem'),
    path('relatorio_censo_uh/', views.Visualizar_Censo_UH.as_view(), name='relatorio_censo_uh'),
]
