...
class BaseDados(models.Model):
    ...
    status_reserva = models.CharField(db_column='STATUS_RESERVA', choices = STATUS_RESERVA_CHOICES, max_length=15, blank=True, null=True)
    ...
    mhex = models.CharField(db_column='MHEx', choices = MHEx_CHOICES, max_length=6, blank=True, null=True)  
    uh = models.CharField(db_column='UH', choices = UH_CHOICES, max_length=2, blank=True, null=True) 
    ...
    valor_ajuste = models.DecimalField(db_column='VALOR_AJUSTE', max_digits=10, decimal_places=2, default=0, null=True, blank=True)  
    ...
    qtde_pet = models.IntegerField(db_column='QTDE_PET', blank=True, null=True)
    ...
    total_pet = models.DecimalField(db_column='TOTAL_PET', max_digits=10, decimal_places=2, default=0)
    ...
    graduacao = models.TextField(db_column='GRADUAÇÃO',max_length=8, choices = GRADUACAO_CHOICES, blank=True, null=True)  
    motivo_viagem = models.TextField(db_column='MOTIVO_VIAGEM',choices = MOTIVO_VIAGEM_CHOICES, max_length=20, blank=True, null=True)
    desc_saude = models.DecimalField(db_column='DESC_SAUDE', max_digits=10, decimal_places=2, default=0)
    observacao = models.TextField(db_column='OBSERVACAO', max_length=100, blank=True, null=True)
